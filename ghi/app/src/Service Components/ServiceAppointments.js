...
function ServiceAppointments() {
    ...
    const handleSubmit = async (e) => {
        ...
        const statusUpdateResponse = await fetch(`http://localhost:8080/api/appointments/${appointmentId}/`, {
            method: "PUT",
                    ...
                    {appointments.map(appointment => {
                        ...
                        return (
                            <tr key={appointment.id}>
                                ...
                                <td onClick={() => specialClick(appointment.id)}>{appointment.status}</td>
                            </tr>
                        )
                    })}
                </tbody>
                ...
                <MDBModalDialog>
                    ...
                    <MDBModalBody>
                        <form id='update-status'>
                            <select onChange={handleFormInput} value={formData.status} name='status' id='status' className='form-control'>
