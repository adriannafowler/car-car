                ...
                <div className="offset-3 col-6">
                    <div className="shadow p-4 mt-4">
                        ...
                        <form onSubmit={handleSubmit} id="add-customer">
                            ...
                            <div className="form-floating mb-3">
                                <input value={formData.address} onChange={handleFormChange} placeholder="Address" type="text" name="address" id="address" className="form-control" />
                                <label htmlFor="address">Address</label>
                            </div>
                            <div className="form-floating mb-3">
                                <input value={formData.phone_number} onChange={handleFormChange} placeholder="Phone Number" type="text" name="phone_number" id="phone_number" className="form-control" />
